...
def render_nx_graph(nx_graph, notebook=True, color_field=None, label_attr=None, title_attr=None):
    ...
    for node in nx_graph.nodes:
        ...
        if color_field:
            attr_color = generate_random_color(nx_graph.nodes[node].get(color_field, "unknown"))
        else:
            attr_color = "#97c2fc"
